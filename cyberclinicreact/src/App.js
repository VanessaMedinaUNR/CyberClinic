  ...
  return (
    <div id = "bounding_box">
        ...
        <div id="external_buttons">
            <button id="signup" type="button" onClick={() => (window.location.href="/signup")}>Sign Up</button>

            <button id="forgotpw" type="button" onClick={() => (window.location.href="/forgotpw")}>Forgot Password</button>
        </div>
